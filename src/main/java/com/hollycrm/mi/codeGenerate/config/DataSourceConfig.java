...
import com.hollycrm.mi.codeGenerate.config.converts.MySqlTypeConvert;
import com.hollycrm.mi.codeGenerate.config.converts.OracleTypeConvert;
    ...
    public List<TableField> getTbfrFields(String tableName){
        ...
        try {
            ...
            while(rsKey.next()){
                ...
                keyName = CodeGenerateUtils.formatVarName(keyName);
            }
            ...
            while(rs.next()){
                ...
                tbfrField.setPropertyName(CodeGenerateUtils.formatVarName(fieldNm));//字段名
